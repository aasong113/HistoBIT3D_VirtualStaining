...
def parse_cmdargs():
    parser = argparse.ArgumentParser(
        description = '20260610_pretrained_BIT2HE'
    )
    parser.add_argument(
        '--root_data_path',
        type=str,
    ...
    'data' : {
        'datasets' : [
            {
                ...
                'name': 'cyclegan',
                'domain': 'A',
                'path': os.path.join(cmdargs.root_data_path, 'example_data_BIT'),
            },
            'shape': (3, 512, 512),
            'transform_train': [
        ...
        },
        {
            'dataset': {
                'name': 'cyclegan',
                'domain': 'B',
                'path': os.path.join(cmdargs.root_data_path, 'example_data_FFPE_HE'),
